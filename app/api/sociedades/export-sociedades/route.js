...
import { writeSheetData } from '../../../../lib/sociedades/sheets.js';
...
const COLS = [
  ...
  { key: 'ult_op',               label: 'Ãšlt. OperaciÃ³n'            },
  { key: 'ult_act',              label: 'Ãšlt. Actividad'            },
  { key: 'ccc',                  label: 'CCC %'                     },
  ...
  { key: 'q_ventas_cria',        label: 'Ventas CrÃ­a'               },
];
...
export async function POST(req) {
  try {
    ...
    // Nombre Ãºnico de pestaÃ±a: incluye fecha + hora para no pisar exportaciones previas
    const now = new Date();
